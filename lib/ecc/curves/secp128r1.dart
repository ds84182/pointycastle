...
class ECCurve_secp128r1 extends ECDomainParametersImpl {
  ...
  factory ECCurve_secp128r1() => constructFpStandardCurve("secp128r1",
    ...
    g: BigInt.parse("04161ff7528b899b2d0c28607ca52c5b86cf5ac8395bafeb13c02da292dded7a83", radix: 16),
    n: BigInt.parse("fffffffe0000000075a30d1b9038a115", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("000e0d4d696e6768756151750cc03a4473d03679", radix: 16)
  );
