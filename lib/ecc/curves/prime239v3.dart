...
class ECCurve_prime239v3 extends ECDomainParametersImpl {
  ...
  new StaticFactoryConfig(ECDomainParameters, "prime239v3");
  ...
  factory ECCurve_prime239v3() => constructFpStandardCurve("prime239v3",
    ...
    b: BigInt.parse("255705fa2a306654b1f4cb03d6a750a30c250102d4988717d9ba15ab6d3e", radix: 16),
    g: BigInt.parse("036768ae8e18bb92cfcf005c949aa2c6d94853d0e660bbf854b1c9505fe95a", radix: 16),
    n: BigInt.parse("7fffffffffffffffffffffff7fffff975deb41b3a6057c3c432146526551", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("7d7374168ffe3471b60a857686a19475d3bfa2ff", radix: 16)
  );
