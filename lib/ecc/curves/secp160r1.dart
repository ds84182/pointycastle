...
class ECCurve_secp160r1 extends ECDomainParametersImpl {
  ...
  factory ECCurve_secp160r1() => constructFpStandardCurve("secp160r1",
    ...
    g: BigInt.parse("044a96b5688ef573284664698968c38bb913cbfc8223a628553168947d59dcc912042351377ac5fb32", radix: 16),
    n: BigInt.parse("100000000000000000001f4c8f927aed3ca752257", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("1053cde42c14d696e67687561517533bf3f83345", radix: 16)
  );
