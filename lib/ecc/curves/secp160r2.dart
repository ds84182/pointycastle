...
class ECCurve_secp160r2 extends ECDomainParametersImpl {
  ...
  factory ECCurve_secp160r2() => constructFpStandardCurve("secp160r2",
    ...
    g: BigInt.parse("0452dcb034293a117e1f4ff11b30f7199d3144ce6dfeaffef2e331f296e071fa0df9982cfea7d43f2e", radix: 16),
    n: BigInt.parse("100000000000000000000351ee786a818f3a1a16b", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("b99b99b099b323e02709a4d696e6768756151751", radix: 16)
  );
