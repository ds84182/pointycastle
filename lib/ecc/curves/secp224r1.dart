...
class ECCurve_secp224r1 extends ECDomainParametersImpl {
  ...
  new StaticFactoryConfig(ECDomainParameters, "secp224r1");

  factory ECCurve_secp224r1() => constructFpStandardCurve("secp224r1",
    ECCurve_secp224r1._make,
    q: BigInt.parse("ffffffffffffffffffffffffffffffff000000000000000000000001", radix: 16),
    ...
    g: BigInt.parse("04b70e0cbd6bb4bf7f321390b94a03c1d356c21122343280d6115c1d21bd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34", radix: 16),
    n: BigInt.parse("ffffffffffffffffffffffffffff16a2e0b8f03e13dd29455c5c2a3d", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("bd71344799d5c7fcdc45b59fa3b9ab8f6a948bc5", radix: 16)
  );
