...
class ECCurve_secp256r1 extends ECDomainParametersImpl {
  ...
  new StaticFactoryConfig(ECDomainParameters, "secp256r1");

  factory ECCurve_secp256r1() => constructFpStandardCurve("secp256r1",
    ECCurve_secp256r1._make,
    q: BigInt.parse("ffffffff00000001000000000000000000000000ffffffffffffffffffffffff", radix: 16),
    ...
    g: BigInt.parse("046b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c2964fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5", radix: 16),
    n: BigInt.parse("ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("c49d360886e704936a6678e1139d26b7819f7e90", radix: 16)
  );
