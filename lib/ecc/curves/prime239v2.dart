...
class ECCurve_prime239v2 extends ECDomainParametersImpl {
  ...
  new StaticFactoryConfig(ECDomainParameters, "prime239v2");
  ...
  factory ECCurve_prime239v2() => constructFpStandardCurve("prime239v2",
    ...
    b: BigInt.parse("617fab6832576cbbfed50d99f0249c3fee58b94ba0038c7ae84c8c832f2c", radix: 16),
    g: BigInt.parse("0238af09d98727705120c921bb5e9e26296a3cdcf2f35757a0eafd87b830e7", radix: 16),
    n: BigInt.parse("7fffffffffffffffffffffff800000cfa7e8594377d414c03821bc582063", radix: 16),
    h: BigInt.one,
    seed: BigInt.parse("e8b4011604095303ca3b8099982be09fcb9ae616", radix: 16)
  );
